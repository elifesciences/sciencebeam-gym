...
from sciencebeam_gym.convert.grobid.grobid_service import (
    GrobidApiPaths
)

from sciencebeam_gym.convert.grobid import grobid_xml_enhancer as grobid_xml_enhancer
from sciencebeam_gym.convert.grobid.grobid_xml_enhancer import (
    GrobidXmlEnhancer
)
